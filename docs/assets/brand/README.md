# NexusRealtime KitBuilder02 Visual Assets

Experimental kit factory for resilient browser peer rooms, routing, secure local model jobs, live mirroring, and optional public tunnels.
